...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<div class="qq-uploader">' +
                ...
                '<div class="qq-upload-button"><b>Drag or select photos(jpg or png) and pdf file to upload.</b> <span style="color:red">Only scanned document will be accepted</span></div>' +
                '<ul class="qq-upload-list"></ul>' +
             '</div>',

        // template for one item in file list
        fileTemplate: '<li id="list_{listID}">' +
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
        var item = qq.toElement(this._options.fileTemplate.replace(/\{listID\}/g, id));
        item.qqFileId = id;
